...
class PrecompilerTestCase(TestCase):
    ...
    def test_precompiler_cache_issue750(self, mock_cache):
        ...
        self.assertEqual("body { color:#990; }", compiler.input())
        self.assertEqual(
            type(compiler.input()), type(smart_text("body { color:#990; }"))
        )
...
@override_settings(
    COMPRESS_ENABLED=True, COMPRESS_URL="/static/",
)
class CssAbsolutizingTestCase(TestCase):
    ...
    def test_css_no_hash(self):
        ...
        params = blankdict({"url": self.expected_url_prefix,})
    ...
    def test_css_absolute_filter_filename_outside_compress_root(self):
        ...
        params = blankdict({"url": self.expected_url_prefix + "bar/qux/",})
        output = self.template % params
        filter = self.filter_class(content)
        self.assertEqual(
...
class SpecializedFiltersTest(TestCase):
    ...
    def test_closure_filter(self):
        ...
        self.assertEqual(
            filter.options,
            (
                ("binary", six.text_type("java -jar compiler.jar")),
                ("args", six.text_type("")),
            ),
        )
    ...
    def test_yuglify_filters(self):
        ...
        self.assertEqual(
            filter.options,
            (
                ("binary", six.text_type("yuglify")),
                ("args", six.text_type("--terminal")),
            ),
        )
    ...
    def test_yui_filters(self):
        ...
        self.assertEqual(
            filter.options,
            (
                ("binary", six.text_type("java -jar yuicompressor.jar")),
                ("args", six.text_type("")),
            ),
        )
    ...
    def test_clean_css_filter(self):
        ...
        self.assertEqual(
            filter.options,
            (("binary", six.text_type("cleancss")), ("args", six.text_type(""))),
        )
