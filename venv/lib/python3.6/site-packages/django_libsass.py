...
def embed_sourcemap(output, sourcemap):
    encoded_sourcemap = base64.standard_b64encode(sourcemap.encode("utf-8"))
    sourcemap_fragment = "sourceMappingURL=data:application/json;base64,{} ".format(
        encoded_sourcemap.decode("utf-8")
    )
...
class SassCompiler(FilterBase):
    def __init__(
        ...
        super(SassCompiler, self).__init__(
    ...
    def input(self, **kwargs):
        if self.filename:
            ...
            return compile(string=self.content, output_style=OUTPUT_STYLE)
